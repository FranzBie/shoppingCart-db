<?php
	...
	if(isset($_POST['btnUpdate'])) {
		...
		if(empty($err)) {
			$strSql = "UPDATE tbl_user SET password = '" . md5($newPassword) . "' WHERE username = '" . $_SESSION['username'] . "'";
		    ...
		    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
				...
				<form method="post" enctype="multipart/form-data">
					<div class="form-group row">
						<label for="txtCurrentPassword" class="col-sm-2 col-form-label text-right">Current Password <span class="text-danger">*</span></label>
						<div class="col-sm-10">
					...
					<div class="form-group row">
						<label for="txtNewPassword" class="col-sm-2 col-form-label text-right">New Password <span class="text-danger">*</span></label>
						<div class="col-sm-10">
					...
					<div class="form-group row">
						<label for="txtReTypePassword" class="col-sm-2 col-form-label text-right">Re-Type Password <span class="text-danger">*</span></label>
						<div class="col-sm-10">
